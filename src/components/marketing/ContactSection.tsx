...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-24 bg-white border-t border-[#E8E8E8]">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="space-y-8">
            <div>
              <span className="label-pill mb-8">Communications</span>
              <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-[#0A0A0A] mt-6 mb-6">
                Initialize <br />
                <span className="text-[#6B6B6B]">Consultation.</span>
              </h2>
              <p className="text-[#6B6B6B] text-lg leading-relaxed max-w-md">
                Whether you're scaling a cleaning empire or optimizing a field 
                service team, our engineers are ready to discuss your integration.
              </p>
            </div>
            ...
            {submitted ? (
              <div className="bg-[#F9F9F9] border border-[#0A0A0A] p-12 text-center animate-in fade-in zoom-in-95 duration-500">
                ...
                <p className="text-sm text-[#6B6B6B] mb-8">
                  Data logged. An operative will contact you shortly.
                </p>
                <Button 
              ...
              >
                <div className="space-y-2">
                  <label htmlFor="name" className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#6B6B6B]">
                    Full Name / Entity
                  </label>
                  <input
                    id="name"
                ...
                <div className="space-y-2">
                  <label htmlFor="email" className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#6B6B6B]">
                    Electronic Mail
                  </label>
                  <input
                    id="email"
                ...
                <div className="space-y-2">
                  <label htmlFor="message" className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#6B6B6B]">
                    Requirement Brief
                  </label>
                  <textarea
                    id="message"
